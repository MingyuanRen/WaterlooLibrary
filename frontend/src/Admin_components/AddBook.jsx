...
function AddBook() {
  ...
  return (
    <form onSubmit={handleSubmit} className="book-form">
      ...
      <input type="text" name="year_of_publication" placeholder="Year of Publication" onChange={handleChange} />
      <input type="text" name="publisher" placeholder="Publisher" onChange={handleChange} />
      <input type="number" name="inventory" placeholder="Inventory" onChange={handleChange} />
      <input type="number" step="0.01" name="price" placeholder="Price" onChange={handleChange} />
